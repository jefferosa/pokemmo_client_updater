...
defaultComboKeys = 
	{
		["F1"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m1"},
		["F2"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m2"},
		["F3"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m3"},
		["F4"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m4"},
		["F5"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m5"},
		["F6"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m6"},
		["F7"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m7"},
		["F8"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m8"},
		["F9"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m9"},
		["F10"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m10"},
		["F11"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m11"},
		["F12"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#s m12"}
		-- ["Ctrl+X"] = {autoSend = true, itemId = nil, subType = nil, useType = nil, value = "#rodsystem"}
	}
perServer = true
perCharacter = true
